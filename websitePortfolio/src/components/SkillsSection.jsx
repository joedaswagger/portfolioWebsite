...
const skills = [
    ...
    { name: "SQL (SQLite)", level: 80, category: "backend"},

    { name: "Git/GitHub", level: 95, category: "tools"},
    { name: "Docker", level: 70, category: "tools"},
    { name: "PyTorch", level: 50, category: "tools"},
    { name: "Visual Studio", level: 50, category: "tools"},
        ...
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredSkills.map((skill, key) => (
                   <div key={key} className="bg-card p-6 shadow-xs card-hover">
                        <div className="text-left mb-4">
                            <h3 className="fond-semibold text-lg"> {skill.name}</h3>
                        </div>
